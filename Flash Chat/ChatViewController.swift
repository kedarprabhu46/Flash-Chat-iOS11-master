...
class ChatViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate {
    ...
    func retrieveMessages(){
        let retriveDB=Database.database().reference().child("Messages")
        retriveDB.observe(.childAdded) { (DataSnapshot) in
            var snapShotValue=DataSnapshot.value as! Dictionary<String,String>
